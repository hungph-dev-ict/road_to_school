                    ...
                    <div class="chat-user-list scrollable">
                        ...
                        <div class="m-b-30">
                            ...
                            <ul class="list-media" id="side-bar-done-conversation">
                                @foreach($doneConversationList as $conversation)
                                    <li class="list-item" id="sidebar-conversation-{{ $conversation->id }}"
                                        data-id="{{ $conversation->id }}">
                                        <a href="javascript:void(0);" class="conversation-toggler media-hover p-h-20">
                                            <div class="media-img">
                    ...
                    <div class="chat-content" id="conversation-box">
                        <div class="conversation" id="conversation-box-{{ $conversation->id }}"
                            ...
                            <div class="conversation-wrapper">
                                ...
                                <div class="conversation-footer" id="chat-area-{{ $conversation->id}}" style="display: none;">
                    ...
                    <div class="chat-content" id="conversation-box">
                        <div class="conversation" id="conversation-box-{{ $conversation->id }}"
                            ...
                            <div class="conversation-wrapper">
                                ...
                                <div class="conversation-footer" id="chat-area-{{ $conversation->id}}">
                                    <button class="upload-btn">
                                        <i class="ti-face-smile"></i>
                                    </button>
                                    <input class="chat-input" id="message-content-{{ $conversation->id }}" type="text"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.chat-app').on('click', '.sent-btn', function (e) {
                e.preventDefault();
                sendMessage($(this).data('id'));
            })

            $('.chat-app').keyup(function(e){
                if(e.keyCode == 13)
                {
                    sendMessage($('.sent-btn').data('id'));
                }
            });
            ...
            function sendMessage(id) {
                ...
                $.ajax({
                    url: '/conversations/' + id + '/storeNewMessage',
                    type: "post",
                    data: {
                        from_id: adminId,
                        content: $('#message-content-' + id).val(),
                    }
                });
                var newMessageHtml = '<div class="msg msg-sent">\n' +
                    '                                            <div class="bubble">\n' +
                    '                                                <div class="bubble-wrapper">\n' +
                    '                                                    <span>' + $('#message-content-' + id).val() +
                    '</span>\n' +
                    '                                                </div>\n' +
                    '                                            </div>\n' +
                    '                                        </div>';
                $('#conversation-body-' + id).append(newMessageHtml);
                $('#message-content-' + id).val('');
                $('.conversation-body').each(function () {
                    updateScroll(this.id);
                });
            }
