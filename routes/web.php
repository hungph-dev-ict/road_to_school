...
//    Route::post('courses/{id}/replyComment/{commentId}', 'User\CourseController@replyComment')->name('courses.comment.store_reply');
        ...
        Route::get('/bills/{userId}/my_bills', 'User\BillController@getMyBill')->name('bills.my_bills');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['access_page', 'is_admin', 'verified', 'locale']], function () {
    ...
    Route::get('/users/create_admin', 'UserController@createNewAdmin')->name('users.create_admin');
    ...
    Route::resource('courses', 'CourseController')->except('create', 'store', 'show');
    ...
    Route::post('/users/create_new_admin', 'UserController@storeNewAdmin')->name('users.store_new_admin');
    Route::post('/users/create_new_instructor', 'UserController@storeNewInstructor')->name('users.store_new_instructor');
    Route::get('/courses/{courseId}/changeCoursePrice', 'CourseController@changeCoursePrice')->name('courses.changeCoursePrice');
    Route::post('/courses/{courseId}/updateCoursePrice', 'CourseController@updateCoursePrice')->name('courses.updateCoursePrice');
});
